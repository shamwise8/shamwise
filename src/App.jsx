...
const OFFERINGS = [
  ...
  { num:"03", icon:"⛓️", title:"Web3 Events Bangkok",
    desc:"Your go-to for crypto and blockchain events in Bangkok. 15 events in 6 months as Avalanche Team1 Thailand Lead.",
...
const COMMUNITY_ITEMS = [
  ...
  { title:"Team1 Thailand", desc:"Avalanche's builder network in Thailand — 15 events in 6 months as Team1 Thailand Lead: builder bootcamps, a 140+ Money 20/20 side event, the 200+ Padel Rave, and more. Ratings 4.86–4.91/5.", photos:["/avalanche-group.jpg","/avalanche-speaker.jpg","/avalanche-bootcamp.jpg"], badge:"TEAM1 THAILAND LEAD", tags:["Bangkok","Avalanche","Team1","Web3"], status:"15 events in 6 months", link:"https://www.shamwise.com/mediakit" },
];
      ...
      <section className="section-pad hero-grid" style={{ padding:"80px 48px 72px", display:"grid", gridTemplateColumns:"1fr 1fr", gap:48, alignItems:"end", background:C.bg, position:"relative", overflow:"hidden" }}>
        ...
        <div className="hero-right" style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:20, animation:"fadeUp 0.8s ease 0.6s both" }}>
          ...
          <div style={{ display:"flex", gap:10, flexWrap:"wrap", justifyContent:"flex-end" }}>
            {["IronMap on 3 App Stores","15 Events in 6 Months","Team1 Thailand Lead"].map(t => (
        ...
        <div className="about-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }}>
          <div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:20, padding:24, background:"#0D0A08", borderRadius:12, border:"1px solid #2D2620" }}>
              {[["3","Apps in TestFlight"],["15","Events run"],["BKK","Based in Bangkok"]].map(([num,label]) => (
                <div key={label}>
